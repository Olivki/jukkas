...
import net.ormr.jukkas.frontend.lexer.TokenType.*
import net.ormr.jukkas.frontend.lexer.TokenType.Companion.ofType
import net.ormr.jukkas.frontend.parser.Precedence.ADDITIVE
import net.ormr.jukkas.frontend.parser.Precedence.CONJUNCTION
import net.ormr.jukkas.frontend.parser.Precedence.DISJUNCTION
import net.ormr.jukkas.frontend.parser.Precedence.EQUALITY
import net.ormr.jukkas.frontend.parser.Precedence.MULTIPLICATIVE
import net.ormr.jukkas.frontend.parser.parselets.infix.AnonymousFunctionInvocationParselet
import net.ormr.jukkas.frontend.parser.parselets.infix.AssignmentParselet
import net.ormr.jukkas.frontend.parser.parselets.infix.BinaryOperationParselet
import net.ormr.jukkas.frontend.parser.parselets.infix.InfixInvocationParselet
import net.ormr.jukkas.frontend.parser.parselets.infix.InfixParselet
import net.ormr.jukkas.frontend.parser.parselets.infix.MemberAccessOperationParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.AnonymousFunctionParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.BooleanParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.FunctionLiteralParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.IfParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.IntParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.ParenthesizedExpressionParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.PrefixParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.ReferenceParselet
import net.ormr.jukkas.frontend.parser.parselets.prefix.ReturnParselet
